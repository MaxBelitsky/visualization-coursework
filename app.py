...
app.layout = html.Div(children=[
    ...
    html.Div(id='dropdown_panel', children=[
        html.Div([
            ...
            dcc.Dropdown(
                id='dropdown_x',
                options=[{'label': value, 'value': value} for value in df.columns],
                #value=['Red blood Cells', 'Lymphosytes']
    ...
    html.Div(id='main_panel', children=[
        ...
        dcc.Graph(
            id='main-graph',
            figure=generate_graph(df, "Red blood Cells", color="SARS-Cov-2 exam result", type="histogram"),
    ...
    html.Div(id='side_panel', children=[
        ...
        ], style={'margin-top': '48px', 'background': 'rgba(0, 128, 0, 0.1)'})
